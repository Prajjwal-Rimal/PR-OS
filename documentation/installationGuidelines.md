1. Navigate to the [Downloads](https://prajjwal-rimal.github.io/pr-os-website/#Download) section on the website, it will redirect you to the guthub release page from where it is possible to download the latest **os_bin.img** file.

2. Open a Virtual Machine manager and create a new virtual machine based on the following guidelines:
    - Do not load the OS as an ISO.
