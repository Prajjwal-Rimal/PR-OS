...
; and its is also for code cleanliness
; the kernel bootloader doesnt see the kernel.asm file at all in the second stage bootloader we added 
...
; acts as a bridge between the bootloader and the kernel
